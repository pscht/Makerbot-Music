...
xy_ppi = 634.74209172 
# z_ppi = 320
z_ppi = 18000 #set z-axis to super pursuit mode (testing only)
...
#                print("had to turn directions...\n")
            ...
            if adapted_distance_xyz[2] > 0: # handle 'rests' in addition to notes. How standard is this pause gcode, anyway?
                vector_length = math.sqrt(adapted_distance_xyz[0]**2 + adapted_distance_xyz[1]**2 + adapted_distance_xyz[2]**2)
#				z-axis sets standards b/c it's the weakest link ;)
                combined_feedrate = (vector_length / adapted_distance_xyz[2]) * adapted_feed_xyz[2]
